...
class Peak:
    ...
    def calculate_parameters(self):
        ...
        x = self.parent.x[self.low_bound_index:self.high_bound_index]
        y = self.parent.y[self.low_bound_index:self.high_bound_index]
    ...
    def print_stats(self, sig_figs: int = 3, **kwargs):
        ...
        print(tabulate(values, stats.keys(), **kwargs))
