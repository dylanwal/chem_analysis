...
def find_peak_largest_single(signal: Signal, mask: DataWeight = None) -> PeakPicking:
    if mask is not None:
    ...
    return PeakPicking(signal, indices_of_peaks)
