...
def process_single(data_path):
    ...
    peaks = chem_analysis.analysis.peaks.integration.rolling_ball(peak_locations, n=5, min_height=0.002, n_points_with_pos_slope=2)
    ...
    ms_peaks = chem_analysis.analysis.peaks.integration.rolling_ball(peak_locations, n=5, min_height=0.002,
