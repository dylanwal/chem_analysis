...
folder_path = pathlib.Path(r"C:\Users\nicep\Desktop\research_wis\data\TS\TS-8")
data_label = "TS8-ketone-N2-t" #"TS7-d4-ketone-t"
times = np.array([0, 10, 20, 30, 40, 50, 60, 75, 90, 105, 120])  #
...
def main():
    ...
    filtered_df.write_csv("TS8-ms.csv")
    print(filtered_df)
