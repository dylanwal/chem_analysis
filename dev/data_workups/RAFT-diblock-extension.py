...
def main():
    # load data
    file_name = r"C:\Users\nicep\Desktop\post_doc_2022\Data\Instrument\polymerization\homo_diblock_data.csv"
    ...
    cal_RI = chem.Calibration(cal_func_RI, lb=160, ub=1_090_000, name="RI calibration")
